...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "ugur", "ugur@gmail.com"),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("ugur", "arslan", "ugur@gmail.com", "Bursa No:4", "Turkey", "Istanbul", "38050");
            var address2 = Address.Of("ali", "kemal", "ali@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");
